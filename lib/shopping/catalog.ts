...
const AISLE_OVERRIDES: Record<string, SupermarketAisle> = {
  ...
  "unsweetened soy milk": "dairy_eggs",
  "soy yogurt": "dairy_eggs",
  ...
  tempeh: "dry_goods",
  edamame: "produce",
  "soy textured protein": "dry_goods",
  "nutritional yeast": "oils_condiments",
  crackers: "bakery",
  croutons: "bakery",
  "whole grain bread": "bakery",
  "whole grain tortilla": "bakery",
...
export const PURCHASE_BY_NAME: Record<string, PurchaseSpec> = {
  ...
  "unsweetened soy milk": { mode: "carton", cartonMl: 1000, label: "soy milk" },
  "soy yogurt": { mode: "tub", tubGrams: 400, label: "soy yogurt" },
  ...
  edamame: { mode: "pack", packGrams: 300, label: "edamame" },
  "soy textured protein": { mode: "pack", packGrams: 250, label: "soy textured protein" },
  "nutritional yeast": { mode: "jar", jarGrams: 100, label: "nutritional yeast" },
  ...
  "whole grain tortilla": { mode: "pack", packGrams: 300, label: "whole grain tortillas" },
